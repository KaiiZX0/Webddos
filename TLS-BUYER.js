 ...
 */
 ...
 if (process.argv.length < 5){console.log(`Usage: node TLS-BUYER.js URL TIME REQ_PER_SEC THREADS\nExample: node TLS-BUYER.js https://tls.mrrage.xyz 300 64 4`); process.exit();}
